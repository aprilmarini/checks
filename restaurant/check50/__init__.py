...
class Calculating(Checks):
    ...
    def testy(self):
        ...
        self.spawn("./restaurant").stdin('y').stdin('y').stdin('y').stdin('y').stdin('y').stdout("The total for your food is $21.00.\n The total with 15% tip is $24.15.\n Thank you for your business!\n", "The total for your food is $21.00.\n The total with 15% tip is $24.15.\n Thank you for your business!\n").exit(0)
        
    @check("compiles")
    def test0(self):
        """0 yields a mean of 0"""
        self.spawn("./restaurant").stdin("n").stdin("n").stdin("n").stdin("n").stdin("n").stdout("The total for your food is $0.00.\n The total with 15% tip is $0.00.\n Thank you for your business!\n", "The total for your food is $0.00.\n The total with 15% tip is $0.00.\n Thank you for your business!\n").exit(0)
